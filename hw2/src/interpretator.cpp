...
inline inline void interpretator::eval_binop(int op) {
    int32_t y = unbox(pop());
    int32_t x = unbox(pop());
    int32_t res;
...
// stack
inline inline int32_t* interpretator::get_stack_bottom() {
    return stack_bottom;
}

inline inline int32_t* interpretator::get_stack_top() {
    return stack_top;
}
